import { Platform, ScrollView, Text, TouchableOpacity, View, Image, Alert, TextInput } from "react-native"
...
const EdituserPage = () => {
  ...
  return (
    <ScrollView className="bg-white">
        ...
        <View className="bg-white flex-row justify-start items-center p-5 border-b border-gray-200">
          <Text className="text-lg w-24">Username</Text>
          <TextInput
            className="text-lg border-b border-gray-300 ml-2 flex-1 py-2"
            maxLength={65}
            value={name}
